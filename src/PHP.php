...
class PHP extends Minify
{
    ...
    public function execute($path = null)
    {
        ...
        // loop files
        foreach ($this->data as $source => $php) {
            // take out strings, comments & regex (for which we've registered
            // the regexes just a few lines earlier)
            $php = $this->replace($php);
            $php = $this->stripWhitespace($php);

            // combine php: separating the scripts by a ;
            $content .= $php.";";
        }
     ...
     * PHP doesn't require statements to be terminated with a semicolon.
